...
namespace Insurance_System.Entity.Context
{
    public partial class Insurance_SystemContext : DbContext
    {

        public Insurance_SystemContext(DbContextOptions<Insurance_SystemContext> options)
            : base(options)
        {
        }
