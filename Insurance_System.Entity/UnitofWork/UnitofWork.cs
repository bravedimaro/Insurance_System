...
namespace Insurance_System.Entity.UnitofWork
{
    public interface IUnitOfWork : IDisposable
    {
        ...
        Insurance_SystemContext Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public Insurance_SystemContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(Insurance_SystemContext context)
        {
            Context = context;
            _disposed = false;
        }
